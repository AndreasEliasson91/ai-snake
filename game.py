...
class SnakeGame:
    def __init__(self, width=640, height=480, fps=20):
        ...
        self.screen = pygame.screen.display.set_mode(self.width, self.height)
    ...
    def is_collision(self, point=None):
        ...
        if point.x + BLOCK_SIZE > self.width or point.x < 0 or \
           point.y + BLOCK_SIZE > self.head or point.y < 0:
            return True
